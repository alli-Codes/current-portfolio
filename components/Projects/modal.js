...
function Modal(props) {
  ...
  return (
    <>
      ...
      >
        <div className="relative h-[70vh] w-[80%] max-w-[70vw]  ">
          ...
          <button
            ...
            className="absolute bg-white-100  w-[2rem] h-[2rem] flex items-center justify-center font-bold text-sm rounded-full right-[-3rem] top-0"
          >
            X
          </button>
        </div>
