...
function Modal(props) {
  ...
  return (
    <>
      <div
        className={`overlay h-full w-full bg-red-400 flex justify-center items-center absolute z-[10000] ${overLayState}`}
      >
        ...
        <button
          onClick={changeState}
          className="absolute bg-white-100 text-blue-400 w-[2rem] h-[2rem] flex items-center justify-center font-bold text-sm rounded-full right-36 top-16"
        >
          X
        </button>
      </div>
